...
from ...models.get_url_asset_upload_job_response import GetUrlAssetUploadJobResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/url-asset-uploads/{job_id}".format(
...
) -> Error | GetUrlAssetUploadJobResponse:
    if response.status_code == 200:
        response_200 = GetUrlAssetUploadJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | GetUrlAssetUploadJobResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Get the result of an asset upload job that was created using the [Create asset upload job via URL
    API](https://www.canva.dev/docs/connect/api-reference/assets/create-url-asset-upload-job/).
...
def sync(
    ...
    *,
    client: AuthenticatedClient,
) -> Error | GetUrlAssetUploadJobResponse | None:
    """<Warning>
