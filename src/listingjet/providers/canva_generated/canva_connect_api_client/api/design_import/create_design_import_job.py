...
from ...models.create_design_import_job_response import CreateDesignImportJobResponse
...
) -> CreateDesignImportJobResponse | Error:
    if response.status_code == 200:
        response_200 = CreateDesignImportJobResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[CreateDesignImportJobResponse | Error]:
    return Response(
...
def sync_detailed(
    *,
    ...
    responses/#asynchronous-job-endpoints) to import an external file as a new design in Canva.
    ...
    [Get design import job API](https://www.canva.dev/docs/connect/api-reference/design-imports/get-
    design-import-job/).
...
def sync(
    *,
    client: AuthenticatedClient,
    body: File,
) -> CreateDesignImportJobResponse | Error | None:
    """Starts a new [asynchronous job](https://www.canva.dev/docs/connect/api-requests-
    responses/#asynchronous-job-endpoints) to import an external file as a new design in Canva.
