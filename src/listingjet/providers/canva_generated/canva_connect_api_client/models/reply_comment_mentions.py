...
T = TypeVar("T", bound="ReplyCommentMentions")


@_attrs_define
class ReplyCommentMentions:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reply_comment_mentions.additional_properties = additional_properties
        return reply_comment_mentions
