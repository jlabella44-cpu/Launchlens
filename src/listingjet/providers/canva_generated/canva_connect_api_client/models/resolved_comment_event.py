...
from ..models.resolved_comment_event_type import ResolvedCommentEventType

if TYPE_CHECKING:
    from ..models.thread import Thread


T = TypeVar("T", bound="ResolvedCommentEvent")


@_attrs_define
class ResolvedCommentEvent:
    """Event type for a comment thread that has been resolved.

    Attributes:
        type_ (ResolvedCommentEventType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ResolvedCommentEventType(d.pop("type"))

        comment_url = d.pop("comment_url")

        comment = Thread.from_dict(d.pop("comment"))

        resolved_comment_event = cls(
            type_=type_,
            comment_url=comment_url,
            comment=comment,
        )

        resolved_comment_event.additional_properties = d
        return resolved_comment_event
