...
from ..models.new_suggestion_event_type_type import NewSuggestionEventTypeType

if TYPE_CHECKING:
    from ..models.thread import Thread


T = TypeVar("T", bound="NewSuggestionEventType")


@_attrs_define
class NewSuggestionEventType:
    """Event type for a new suggestion.

    Attributes:
        type_ (NewSuggestionEventTypeType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = NewSuggestionEventTypeType(d.pop("type"))

        suggestion_url = d.pop("suggestion_url")

        suggestion = Thread.from_dict(d.pop("suggestion"))

        new_suggestion_event_type = cls(
            type_=type_,
            suggestion_url=suggestion_url,
            suggestion=suggestion,
        )

        new_suggestion_event_type.additional_properties = d
        return new_suggestion_event_type
