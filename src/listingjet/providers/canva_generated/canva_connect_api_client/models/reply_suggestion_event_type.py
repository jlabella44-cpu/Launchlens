...
from ..models.reply_suggestion_event_type_type import ReplySuggestionEventTypeType

if TYPE_CHECKING:
    from ..models.reply import Reply


T = TypeVar("T", bound="ReplySuggestionEventType")


@_attrs_define
class ReplySuggestionEventType:
    """Event type for a reply to a suggestion.

    Attributes:
        type_ (ReplySuggestionEventTypeType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ReplySuggestionEventTypeType(d.pop("type"))

        reply_url = d.pop("reply_url")

        reply = Reply.from_dict(d.pop("reply"))

        reply_suggestion_event_type = cls(
            type_=type_,
            reply_url=reply_url,
            reply=reply,
        )

        reply_suggestion_event_type.additional_properties = d
        return reply_suggestion_event_type
