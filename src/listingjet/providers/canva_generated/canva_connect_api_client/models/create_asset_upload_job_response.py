...
T = TypeVar("T", bound="CreateAssetUploadJobResponse")


@_attrs_define
class CreateAssetUploadJobResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_asset_upload_job_response = cls(
            job=job,
        )

        create_asset_upload_job_response.additional_properties = d
        return create_asset_upload_job_response
