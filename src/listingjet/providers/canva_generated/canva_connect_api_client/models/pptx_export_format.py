...
from ..models.pptx_export_format_type import PptxExportFormatType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PptxExportFormat")


@_attrs_define
class PptxExportFormat:
    """Export the design as a PPTX.

    Attributes:
        type_ (PptxExportFormatType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = PptxExportFormatType(d.pop("type"))

        pages = cast(list[int], d.pop("pages", UNSET))

        pptx_export_format = cls(
            type_=type_,
            pages=pages,
        )

        pptx_export_format.additional_properties = d
        return pptx_export_format
