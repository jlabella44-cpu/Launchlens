...
from ..models.thread_mention_event_content_type import ThreadMentionEventContentType

if TYPE_CHECKING:
    from ..models.thread import Thread


T = TypeVar("T", bound="ThreadMentionEventContent")


@_attrs_define
class ThreadMentionEventContent:
    """Content for a mention in a comment thread.

    Attributes:
        type_ (ThreadMentionEventContentType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ThreadMentionEventContentType(d.pop("type"))

        comment_url = d.pop("comment_url")

        comment = Thread.from_dict(d.pop("comment"))

        thread_mention_event_content = cls(
            type_=type_,
            comment_url=comment_url,
            comment=comment,
        )

        thread_mention_event_content.additional_properties = d
        return thread_mention_event_content
