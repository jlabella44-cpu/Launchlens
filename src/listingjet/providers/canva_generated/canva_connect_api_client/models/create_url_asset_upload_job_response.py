...
T = TypeVar("T", bound="CreateUrlAssetUploadJobResponse")


@_attrs_define
class CreateUrlAssetUploadJobResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_url_asset_upload_job_response = cls(
            job=job,
        )

        create_url_asset_upload_job_response.additional_properties = d
        return create_url_asset_upload_job_response
