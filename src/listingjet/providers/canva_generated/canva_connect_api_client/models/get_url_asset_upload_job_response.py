...
T = TypeVar("T", bound="GetUrlAssetUploadJobResponse")


@_attrs_define
class GetUrlAssetUploadJobResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_url_asset_upload_job_response = cls(
            job=job,
        )

        get_url_asset_upload_job_response.additional_properties = d
        return get_url_asset_upload_job_response
