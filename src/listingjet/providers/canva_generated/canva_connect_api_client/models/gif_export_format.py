...
from ..models.gif_export_format_type import GifExportFormatType
from ..types import UNSET, Unset

T = TypeVar("T", bound="GifExportFormat")


@_attrs_define
class GifExportFormat:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = GifExportFormatType(d.pop("type"))
        ...
        gif_export_format.additional_properties = d
        return gif_export_format
