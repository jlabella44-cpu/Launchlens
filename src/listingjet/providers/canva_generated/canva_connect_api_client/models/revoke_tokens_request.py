...
T = TypeVar("T", bound="RevokeTokensRequest")
...
class RevokeTokensRequest:
    ...
    Attributes:
        token (str): The token to revoke. Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revoke_tokens_request = cls(
            token=token,
            client_id=client_id,
            client_secret=client_secret,
        )

        revoke_tokens_request.additional_properties = d
        return revoke_tokens_request
