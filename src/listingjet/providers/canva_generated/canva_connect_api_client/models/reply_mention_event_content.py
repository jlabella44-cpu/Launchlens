...
from ..models.reply_mention_event_content_type import ReplyMentionEventContentType

if TYPE_CHECKING:
    from ..models.reply import Reply


T = TypeVar("T", bound="ReplyMentionEventContent")


@_attrs_define
class ReplyMentionEventContent:
    """Content for a mention in a comment reply.

    Attributes:
        type_ (ReplyMentionEventContentType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ReplyMentionEventContentType(d.pop("type"))

        reply_url = d.pop("reply_url")

        reply = Reply.from_dict(d.pop("reply"))

        reply_mention_event_content = cls(
            type_=type_,
            reply_url=reply_url,
            reply=reply,
        )

        reply_mention_event_content.additional_properties = d
        return reply_mention_event_content
